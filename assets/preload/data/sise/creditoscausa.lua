...
function onCreate()
	...
	makeLuaText('JukeBoxText', 'Sise', 400, -405-IntroTagWidth, 30+ 200)
	...
	makeLuaText('JukeBoxSubText', "cancion po", 400, -405-IntroTagWidth, 80+ 200)
	setTextAlignment('JukeBoxSubText', 'left')
	setObjectCamera('JukeBoxSubText', 'other')
	setTextSize('JukeBoxSubText', IntroSubTextSize - 8)
	addLuaText('JukeBoxSubText')
	makeLuaText('more', "Remix By Pohsan", 400, -405-IntroTagWidth, 125+ 200)
